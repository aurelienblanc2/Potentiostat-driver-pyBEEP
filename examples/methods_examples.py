...
cv_params = {"start": -0.5, "vertex1": 0.5, "vertex2": -0.5, "end": -0.5, "scan_rate": 1, "cycles": 2}
...
gcv_params = {"start": -1e-3, "vertex1": 1e-3, "vertex2": -1e-3, "end": -1e-3, "num_steps": 40, "step_duration": 0.05, "cycles": 2}
